<?php
/**
* FAQ plugin for Smartpartner
*
* This file holds functions to allow FAQ use Smartpartner items as attachment.
*
...
function faq_smartpartner_getItemTitle($itemid = 0) {
...
function faq_smartpartner_getItemUrl($itemid = 0) {
	// Creating the partner handler object
	$smartpartner_partner_handler = & smartpartner_gethandler ( 'partner' );
...
function faq_smartpartner_showItemsTable($startpartner = 0, $query = '') {
...
function faq_smartpartner_accessGranted($itemid=0) {
	global $xoopsUser;
