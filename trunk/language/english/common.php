...
define("_CO_FAQ_READMORE", "Read more...");

// faq
define("_CO_FAQ_FAQ_FAQ_ID", "Id");
define("_CO_FAQ_FAQ_FAQ_ID_DSC", " ");
define("_CO_FAQ_FAQ_FAQ_QUESTION", "Question");
define("_CO_FAQ_FAQ_FAQ_QUESTION_DSC", " ");
define("_CO_FAQ_FAQ_FAQ_MENUTITLE", "Title in menu");
define("_CO_FAQ_FAQ_FAQ_MENUTITLE_DSC", " ");
define("_CO_FAQ_FAQ_FAQ_ANSWER", "Answer");
define("_CO_FAQ_FAQ_FAQ_ANSWER_DSC", " ");
define("_CO_FAQ_FAQ_FAQ_UID", "Author");
define("_CO_FAQ_FAQ_FAQ_UID_DSC", " ");
define("_CO_FAQ_FAQ_FAQ_CID", "Category");
define("_CO_FAQ_FAQ_FAQ_CID_DSC", " ");
define("_CO_FAQ_FAQ_FAQ_DIDUNO", "Did you know?");
define("_CO_FAQ_FAQ_FAQ_DIDUNO_DSC", "This will be used in the Did You Know block.");
define("_CO_FAQ_FAQ_FAQ_STATUS", "Status");
define("_CO_FAQ_FAQ_FAQ_STATUS_DSC", " ");
define("_CO_FAQ_FAQ_FAQ_PUBLISHED_DATE", "Published Date");
define("_CO_FAQ_FAQ_FAQ_PUBLISHED_DATE_DSC", " ");
define("_CO_FAQ_FAQ_FAQ_CANCOMMENT", "Can Comment?");
define("_CO_FAQ_FAQ_FAQ_CANCOMMENT_DSC", " ");
define("_CO_FAQ_FAQ_FAQ_WEIGHT", "Weight");
...
define("_CO_FAQ_FAQ_FAQ_NOTIFYPUB", "Notify on approval?");

define("_CO_FAQ_FAQ_STATUS_PUBLISHED", "Published");
define("_CO_FAQ_FAQ_STATUS_PENDING", "Pending");
define("_CO_FAQ_FAQ_STATUS_REJECTED", "Rejected");
define("_CO_FAQ_FAQ_STATUS_OFFLINE", "Offline");

define("_CO_FAQ_FAQ_READ", "View Permission");
...
define("_CO_FAQ_FAQ_INFO", "Published by %s on %s. (%u reads)");
define("_CO_FAQ_FAQ_FROM_USER", "All contents of %s");
define("_CO_FAQ_FAQ_COMMENTS_INFO", "%d comments");
define("_CO_FAQ_FAQ_NO_COMMENT", "No comment");

define("_CO_FAQ_SUBMITTED_FAQS", "<h1>User's submitted FAQs</h1>");
define("_CO_FAQ_REQUESTED_FAQS", "<h1>User's requested FAQs</h1>");

// category
define("_CO_FAQ_CATEGORY_CAT_ID", "Id");
define("_CO_FAQ_CATEGORY_CAT_ID_DSC", " ");
define("_CO_FAQ_CATEGORY_CAT_TITLE", "Title");
define("_CO_FAQ_CATEGORY_CAT_TITLE_DSC", " ");
define("_CO_FAQ_CATEGORY_CAT_MENUTITLE", "Title in menu");
define("_CO_FAQ_CATEGORY_CAT_MENUTITLE_DSC", " ");
define("_CO_FAQ_CATEGORY_CAT_PID", "Parent category");
define("_CO_FAQ_CATEGORY_CAT_PID_DSC", "If you want this new category to be a sub-category, select a parent here. If it is to be a top level category, leave this blank.");
define("_CO_FAQ_CATEGORY_CAT_SUMMARY", "Summary");
define("_CO_FAQ_CATEGORY_CAT_SUMMARY_DSC", " ");
define("_CO_FAQ_CATEGORY_CAT_DESCRIPTION", "Description");
define("_CO_FAQ_CATEGORY_CAT_DESCRIPTION_DSC", " ");
define("_CO_FAQ_CATEGORY_CAT_WEIGHT", "Weight");
define("_CO_FAQ_CATEGORY_CAT_WEIGHT_DSC", " ");
define("_CO_FAQ_CATEGORY_CAT_PUBLISHED_DATE", "Published Date");
...
define("_CO_FAQ_CATEGORY_CAT_SUBS", "SubCategories");
define("_CO_FAQ_CATEGORY_CAT_SUBS_DSC", " ");

define("_CO_FAQ_CATEGORY_STATUS_ACTIVE", "Active");
define("_CO_FAQ_CATEGORY_STATUS_INACTIVE", "Inactive");

define("_CO_FAQ_CATEGORY_READ", "View Permission");
...
define("_CO_FAQ_CATEGORY_WRITE", "Write Permission");
...
define("_CO_FAQ_ATTACHMENT_ATTACH_WEIGHT", "Weight");
...
define("_CO_FAQ_ATTACHMENT_STATUS_ACTIVE", "Show");
define("_CO_FAQ_ATTACHMENT_STATUS_INACTIVE", "Hide");

define("_CO_FAQ_ATTACHMENT_READ", "View Permission");
