...
define("_MI_FAQ_MD_DESC", "Advanced Questions and Answers Management System for your ImpressCMS Site");

define("_MI_FAQ_INDEX", "Index");
define("_MI_FAQ_FAQS", "Faqs");
define("_MI_FAQ_CATEGORYS", "Categories");
define("_MI_FAQ_ATTACHMENTS", "Attachments");
define("_MI_FAQ_IMPORT", "Import");

//Menu
define('_MI_FAQ_FAQ_ADD','Submit new FAQ');
define('_MI_FAQ_REQUEST_ADD','Request an answer');

//Blocks
define('_MI_FAQ_CATEGLIST','Category List');
define('_MI_FAQ_CATEGLISTDSC','Block to show a simple category list');
define('_MI_FAQ_RANDOM_DIDUNO','Random "Did you know?"');
define('_MI_FAQ_RANDOM_DIDUNODSC','Block to show a random Did you know question');
define('_MI_FAQ_RECENT_QUESTIONS','Recent Questions');
define('_MI_FAQ_RECENT_QUESTIONSDSC','Block to show the recent questions');

// Configs
define("_MI_FAQ_ALLOWSUBMIT", "User submissions");
define("_MI_FAQ_ALLOWSUBMITDSC", "Allow users to submit FAQs on your website?");
define("_MI_FAQ_ALLOWREQUEST", "User requests");
define("_MI_FAQ_ALLOWREQUESTDSC", "Allow users to request FAQs on your website?");
define('_MI_FAQ_DATEFORMAT', 'Date format');
...
define('_MI_FAQ_DISPLAY_TOPCAT_DSC', 'Display top categories description?');
...
define('_MI_FAQ_TOPCAT_DSC_COUNT', 'Max-length of the top category description');
define('_MI_FAQ_TOPCAT_DSC_COUNTDSC', "Define how much characters will be displayed in the top category description.");
define('_MI_FAQ_DISPLAY_SUBCAT_INDEX', 'Display sub-categories on index?');
define('_MI_FAQ_DISPLAY_SUBCAT_INDEXDSC', "Select 'Yes' to display subcategories on the index page.");
define('_MI_FAQ_DISPLAY_SUBCAT_DSC', 'Display sub-categories description?');
...
define('_MI_FAQ_SUBCAT_DSC_COUNT', 'Max-length of the top category description');
...
define('_MI_FAQ_AUTOAPPROVE_SUB_FAQ', 'Auto approve submitted FAQs?');
define('_MI_FAQ_AUTOAPPROVE_SUB_FAQDSC', 'Auto approves submitted FAQs without admin intervention.');
define('_MI_FAQ_SHOW_FAQ_INFO', 'Show FAQs info?');
define('_MI_FAQ_SHOW_FAQ_INFO_DSC', 'Select "YES" to show the FAQ author, published date and counter.');
define("_MI_FAQ_LIMIT", "Faqs limit");
define("_MI_FAQ_LIMITDSC", "Number of faqs to display on user side.");
define("_MI_FAQ_CATSLIMIT", "Categories limit");
define("_MI_FAQ_CATSLIMITDSC", "Number of cateogries to display on user side.");
...
define("_MI_FAQ_FOOTER", "Module Footer Text");
...
define('_MI_FAQ_USEREALNAME', 'Use the Real Name of users?');
...
define('_MI_FAQ_CATEGS_ORDER', 'Sort Categories/Subcategories by');
define('_MI_FAQ_CATEGS_ORDERDSC', 'Select how to sort the categories/subcategories list on index page.');
define('_MI_FAQ_FAQS_ORDER', 'Sort FAQs by');
define('_MI_FAQ_FAQS_ORDERDSC', 'Select how tp sort the FAQs list on categories page.');

define('_MI_FAQ_SORT_WEIGHT', 'Weight');
define('_MI_FAQ_SORT_PUBDATEASC', 'Published Date ASC');
define('_MI_FAQ_SORT_PUBDATEDESC', 'Published Date DESC');

// Notifications
define('_MI_FAQ_GLOBAL_FAQ_NOTIFY', "Global Faqs");
...
define('_MI_FAQ_GLOBAL_FAQ_SUBMITTED_NOTIFY', "FAQ submitted");
...
define('_MI_FAQ_FAQ_APPROVED_NOTIFY', "FAQ approved");
...
define("_MI_FAQ_GLOBAL_FAQ_NEW_NOTIFY", "New FAQ");
